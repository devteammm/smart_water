...
def seed_device_collect():
    ...
    for device in digital_devices:
        ...
        for i in range(4):
            ...
            last_value = value
            DigitalWaterDevice.objects.create(year=year,mounth=mounth -i,device=device,value=value)
    ...
    for device in mechanics_devices:
        ...
        for i in range(4):
            value = randint(20,200) + last_value
            last_value = value
            MechanicsWaterDevice.objects.create(year=year,mounth=mounth -i,device=device,value=value)
